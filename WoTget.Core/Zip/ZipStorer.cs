...
namespace System.IO.Compression
{
    ...
    public class ZipStorer : IDisposable
    {
        ...
        /// <returns>A valid ZipStorer object</returns>
        public static ZipStorer Create(Stream _stream, string _comment, bool leaveOpen = false)
        {
            ZipStorer zip = new ZipStorer();
            zip.Comment = _comment;
            zip.ZipFileStream = _stream;
            zip.Access = FileAccess.Write;
            zip.leaveOpen = leaveOpen;
            return zip;
        }
        /// <summary>
        ...
        /// <returns>A valid ZipStorer object</returns>
        public static ZipStorer Open(Stream _stream, FileAccess _access,bool leaveOpen=false)
        {
        ...
        public void AddStream(Compression _method, string _filenameInZip, Stream _source, DateTime _modTime, string _comment)
        {
            ...
            //Prevent doubles
            if (Files.Exists(z => z.FilenameInZip == zfe.FilenameInZip))
                return;
        ...
        */
        private void WriteCentralDirRecord(ZipFileEntry _zfe)
        {
            ...
            this.ZipFileStream.Write(BitConverter.GetBytes((ushort)0), 0, 2); // External file attributes 0x8100 (normal/readable)
        ...
        */
        ...
        private void Store(ref ZipFileEntry _zfe, Stream _source)
        {
            ...
            if (_source!=null &&_zfe.Method == Compression.Deflate && !this.ForceDeflating && _source.CanSeek && _zfe.CompressedSize > _zfe.FileSize)
            {
