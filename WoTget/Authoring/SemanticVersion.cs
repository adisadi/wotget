...
namespace WoTget.Core.Authoring
{
    ...
    /// stolen from https://github.com/NuGet/NuGet2/blob/2.11/src/Core/SemanticVersion.cs
    /// </summary>
    public sealed class SemanticVersion : IComparable, IComparable<SemanticVersion>, IEquatable<SemanticVersion>
    {
        ...
        public static SemanticVersion Parse(string version)
        {
            ...
            {
                throw new ArgumentException("Argument cannot be null", "version");
            }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (other == null)
            {
                throw new ArgumentException("Not a semantic Version", "obj");
            }
